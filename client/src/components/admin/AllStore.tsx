...
const AllStore = () => {
    ...
    return (
        ...
        <div className="h-14 flex items-center justify-center bg-blue-600 text-white rounded text-2xl font-bold">All Store</div>
        <div className="min-h-[91vh] flex items-center py-10 flex-col gap-5">
