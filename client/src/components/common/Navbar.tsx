...
const Navbar = () => {
    ...
    return (
        <div className="w-full md:px-20 h-full sticky top-0 left-0 z-[99999] shadow-lg ">
            <div className="flex items-center justify-between h-full w-full">
                <div className="h-full md:w-auto w-full justify-between flex z-50 shadow-lg md:shadow-none px-4 md:px-0">
                ...
                <ul className={`bg-white md:hidden fixed w-full top-0 bottom-0 py-16 pl-6 duration-500 ${isSidebarOpen ? "left-0" : "left-[-100%]"}`}>
                    ...
                    <li className="my-4">
                        <Link to="/" onClick={() => setIsSidebarOpen(false)} className="hover:text-cyan-600 cursor-pointer duration-300 font-semibold ">Latest</Link>
                    </li>
                </ul>
            </div>
        </div>
